...
export function DefaultLayout() {
        ...
        {auth.token ? (
          <div>
                <button
                    ...
                    >
                        <span className="font-medium text-xl">{auth.user || "User"}</span>
                        <svg
                    ...
                    {open && (
                            ...
                            <ul className="py-2 text-sm">
                                <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-100 text-xl font-normal">
                                    Profile
                                </a>
                                </li>
                                <li>
  ...
  <footer className="w-full bg-gray-800 text-white mt-8">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        {/* Brand + Contact */}
        <div>
          <h1 className="text-3xl font-bold text-blue-400 mb-4 cursor-pointer">MyShop</h1>
          <p className="text-gray-300 mb-2 cursor-pointer">Contact Us:</p>
          <p className="text-gray-400 cursor-pointer">duttagourav047@gmail.com</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="#" className="hover:text-amber-300">About Us</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Careers</Link></li>
            <li><Link to="#" className="hover:text-amber-300">MyShop Stories</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Corporate Information</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="#" className="hover:text-amber-300">Payments</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Shipping</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Cancellation & Returns</Link></li>
            <li><Link to="#" className="hover:text-amber-300">FAQ</Link></li>
          </ul>
        </div>

        {/* Consumer Policy Section */}
        <div>
          <h2 className="text-lg font-semibold mb-4 cursor-pointer">CONSUMER POLICY</h2>
          <ul className="space-y-2">
            <li><Link to="#" className="hover:text-amber-300">Cancellation & Returns</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Terms Of Use</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Security</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Privacy</Link></li>
            <li><Link to="#" className="hover:text-amber-300">Sitemap</Link></li>
          </ul>
        </div>
