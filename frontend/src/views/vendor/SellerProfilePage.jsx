  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="text-right">
        <Link to="/seller/layout/update/profile">
      ...
      <div>
        ...
        <div className="mb-6">
          <Link to="/seller/layout/add/Address">
            <button
              className="
        px-5 py-2 
        bg-blue-600 
            ...
            {user.address.map((addr) => (
              <div key={addr.id} className="flex flex-col justify-between">
                ...
                >
                  ...
                  <p className="text-gray-800">
                    <span className="font-semibold">SHOP:</span> {addr.shop_line}
                  </p>
                </div>

                {/* Update Button */}
                <div className="mt-2 text-right">
                  <Link to={`/seller/layout/update/Address/${addr.id}`}>
